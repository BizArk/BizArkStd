...
using BizArk.Standard.Core.Extensions.TypeExt;
using BizArk.Standard.Core.Extensions.FormatExt;
using BizArk.Standard.Core.Convert.Strategies;
using System.Diagnostics;

namespace BizArk.Standard.Core.Convert
{
	...
	internal class BaConverter
	{
		...
		{
			var prop = type.GetTypeInfo().GetField(fieldName, BindingFlags.Public | BindingFlags.Static);
