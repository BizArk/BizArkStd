...
namespace BizArk.Standard.Core.Extensions.StringExt
{
	/// <summary>
	...
	public static class StringExt
	{
		...
		/// </summary>
		/// <param name="str"></param>
		/// <param name="encoding">The encoding to use to write the string to the stream. If null, uses Application.DefaultEncoding.</param>
		/// <returns></returns>
		public static Stream ToStream(this string str, Encoding encoding = null)
		{
			var ms = new MemoryStream();
			var sw = new StreamWriter(ms, encoding ?? Application.DefaultEncoding);
			sw.Write(str);
			sw.Flush();
			ms.Position = 0;
			return ms;
		...
		/// </summary>
		/// <param name="str"></param>
		/// <param name="encoding">The encoding to use to write the string to array of bytes. If null, uses Application.DefaultEncoding.</param>
		/// <returns></returns>
		public static byte[] ToBytes(this string str, Encoding encoding = null)
		{
			return (encoding ?? Application.DefaultEncoding).GetBytes(str);
