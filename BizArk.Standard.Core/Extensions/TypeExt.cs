...
namespace BizArk.Standard.Core.Extensions.TypeExt
{
    /// <summary>
    ...
    public static class TypeExt
    {
        ...
        public static bool Implements(this Type type, Type interfaceType)
        {
            ...
            foreach (Type i in ti.GetInterfaces())
        ...
        public static bool IsDerivedFrom(this Type type, Type baseType)
        {
            ...
            return bti.IsAssignableFrom(type);
        }
        ...
        public static string GetCSharpName(this Type type)
        {
            ...
            if (type.GetTypeInfo().IsValueType && type.AllowNull()) name += "?";
        ...
        public static FieldInfo[] GetFields<T>(this Type type, BindingFlags flags = BindingFlags.Default)
        {
			...
			var ti = type.GetTypeInfo();
            foreach (var fld in ti.GetFields(flags))
            {
